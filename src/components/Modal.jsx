...
import "./modal.css";
const Modal = () => {
  const { setClickCount, setLevel, setModalOpen , level , setIsActive } = useContext(MyContext);
  ...
  return (
    <div>
        ...
        <h2>Welcome to the Cat Bubble Hunt!</h2>
            <p>Can you find the hidden cat amidst the sea of colorful bubbles?</p>
            <p>Instructions:</p>
            <ul>
            ...
            <div className="circle" style={{ top: getRandomCoordinate(), left: getRandomCoordinate() }}></div>
              <div className="circle" style={{ top: getRandomCoordinate(), left: getRandomCoordinate() }}></div>
              <div className="circle" style={{ top: getRandomCoordinate(), left: getRandomCoordinate() }}></div>
        </div>
      </div></> :
      <div className="modal">
        <div className="modal-content">
          <h2>Congrats You found the cat!!</h2>
          <p>Would you like to go to the next level?</p>
